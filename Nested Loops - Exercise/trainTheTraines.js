function solve(input) {
  ...
  while (namePresentation != "Finish") {
    //цикъл, докато не стигне до елемент Finish
    ...
    for (let i = counter; i < counter + n; i++) {
      // Цикъл, който се върти от сегашния елемент на масива до сумата на сегашния плюс броя хора в журито- тоест да обходи само оценките за текущата презентация
    ...
    console.log(
      `${namePresentation} - ${averageGradePerPresentation.toFixed(2)}.`
    ); //Изписване на информацията след приключване обработването на тази презентация
